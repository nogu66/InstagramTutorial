...
extension User {
    static var MOCK_USERS: [User] = [
        ...
        .init(id: NSUUID().uuidString, username:  "venom-2", profileImageUrl: "venom-2", fullname: "Eddie Brock", bio: "venom", email: "venom@gmail.com"),
        .init(id: NSUUID().uuidString, username:  "ironman", profileImageUrl: "iron-man-1", fullname: "Tony Stark", bio: "Playboy & Billionaric", email: "batman@gmail.com"),
